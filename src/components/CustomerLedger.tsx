...
import { Users, Plus, Search, CreditCard, DollarSign, Calendar, Phone, Mail } from "lucide-react";
            ...
            <TableBody>
              {filteredCustomers.map(customer => (
                <TableRow key={customer.id}>
                  ...
                  <TableCell>
                    <span className={(customer.currentBalance || 0) > 0 ? 'text-red-600 font-bold' : 'text-green-600'}>
